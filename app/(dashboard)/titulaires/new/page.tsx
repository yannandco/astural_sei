...
export default function CreateTitulairePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/titulaires', {
        method: 'POST',
      ...
      if (res.ok) {
        ...
        router.push(`/titulaires/${data.data.id}`)
      }
    } catch (error) {
    ...
    <div>
      ...
      <div className="ds-header">
        <div className="ds-header-content">
          <div className="ds-header-left">
            ...
            <div>
              <h1 className="ds-header-title">Nouveau titulaire</h1>
              <p className="ds-header-subtitle">Créer une nouvelle fiche titulaire</p>
            </div>
          </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end gap-3 mt-4">
          <Link href="/titulaires" className="btn btn-secondary">Annuler</Link>
